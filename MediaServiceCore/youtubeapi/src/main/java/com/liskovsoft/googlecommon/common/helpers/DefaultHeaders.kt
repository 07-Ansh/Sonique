...
object DefaultHeaders {
    ...
    private const val ACCEPT_ENCODING_COMPRESSED = "gzip, deflate, br"  
    private const val ACCEPT_ENCODING_COMPRESSED_LITE = "gzip, deflate"  
    ...
    const val USER_AGENT_TV = USER_AGENT_FIRE_TV  
    ...
    @JvmField
    val APP_USER_AGENT = USER_AGENT_TV  
