...
public interface PoTokenProvider {
    ...
    /**
     * Get a {@link PoTokenResult} specific to the Android com.sonique.app, a.k.a. the ANDROID InnerTube client.
     *
     * <p>
     * Implementation details are not known, the com.sonique.app uses DroidGuard, a downloaded native virtual
     * machine ran by Google Play Services for which its code is updated pretty frequently.
     * </p>
     *
     * <p>
     * As of writing, DroidGuard seem to check for the Android com.sonique.app signature and package ID, as
    ...
    /**
     * Get a {@link PoTokenResult} specific to the iOS com.sonique.app, a.k.a. the IOS InnerTube client.
     *
     * <p>
     * Implementation details are not known, the com.sonique.app seem to use something called iosGuard which
