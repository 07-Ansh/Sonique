...
-keep class com.sonique.domain.data.model.** { *; }
...
-keep class com.sonique.app.data.model.** { *; }
-keep class com.sonique.app.extension.AllExtKt { *; }
-keep class com.sonique.app.extension.AllExtKt$* { *; }
-keep class com.sonique.kotlinytmusicscraper.extension.MapExtKt$* { *; }
...
-dontwarn com.sonique.data.di.loader.LoaderKt
-dontwarn com.sonique.media3.ui.MediaPlayerViewKt
...
-keep class com.sonique.data.di.** { *; }
