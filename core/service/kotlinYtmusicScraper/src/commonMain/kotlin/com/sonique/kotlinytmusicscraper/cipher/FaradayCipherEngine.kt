...
class FaradayCipherEngine(
     ...
     * 192 MB limit apiece, one of which is then disposed while the other is mid-flight. A lock across
     * the whole entry point prevents race conditions and memory pressure.
     */
